...
BEDROCK_MODEL=us.anthropic.claude-sonnet-4-20250514-v1:0,us.amazon.nova-premier-v1:0
VECTOR_STORE=1
PDF_LOCAL_CONVERT=0
BEDROCK_TIMEOUT=900
```
...
- `us.anthropic.claude-sonnet-4-20250514-v1:0` - Latest Claude model with 1M token context
...
python bedbot.py --model us.anthropic.claude-sonnet-4-20250514-v1:0 --debug
```
...
---
Generated by: us.anthropic.claude-sonnet-4-20250514-v1:0
```
